...
function Footer() {
  return (
    <footer className="bg-dark-blue border-t border-code-green/10 py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Section */}
          <div>
            <h3 className="text-2xl font-bold bg-gradient-to-r from-code-green to-[#80FFF2] text-transparent bg-clip-text mb-4">
              SkillBridge
            </h3>
          ...
          <div>
            <h4 className="text-white font-semibold mb-4 relative inline-block">
              For Clients
              <div className="absolute -bottom-1 left-0 w-1/2 h-0.5 bg-gradient-to-r from-code-green to-transparent"></div>
            </h4>
        ...
        {/* Bottom Section */}
        <div className="mt-12 pt-8 border-t border-code-green/10">
